...
do Python).
'''
fila1=[] # preencha com todo o conteúdo após a sequência de operações
...
'''
fila2=[] # preencha com todo o conteúdo após a sequência de operações
...
proximo = None # troque pelo valor correto
...
minha_fila = None # troque pela instanciação
...
# faça aqui sua sequência de chamadas para operar sobre minha_fila
...
nova_fila = None # troque None pela criação do objeto
# faça as operações
...
def insere_varios(lista):
    pass # remova esse 'pass' e escreva sua função aqui.
...
def embarca(pessoas):
    pass # tire esse pass e implemente a função!
...
Vamos agora fazer uma função que simula fila de baco.
